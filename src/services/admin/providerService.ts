...
export const getAllProviders = async (page: number, limit: number): Promise<{ providers: HydratedDocument<IProvider>[], totalProviders: number }> => {
...
export const getProviderById = async (id: string): Promise<HydratedDocument<IProvider> | null> => {
...
export const updateProvider = async (id: string, providerData: Partial<IProvider>): Promise<HydratedDocument<IProvider> | null> => {
...
export const updateProviderVerification = async (id: string, isVerified: boolean): Promise<HydratedDocument<IProvider> | null> => {
